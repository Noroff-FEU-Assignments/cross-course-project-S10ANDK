...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '2022040444444443_flowerpower_306771a4542fd4041827_20220421155432_archive.zip';
	const ARCHIVE_SIZE		 = '57815835';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '306771a-21155432';
    const SECONDARY_PACKAGE_HASH = '7480270-21155432';
	const VERSION			 = '1.4.5';
